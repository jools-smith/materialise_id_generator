 ...
 *         &lt;element name="contacts" type="{urn:com.flexnet.external.type}OrgUnitContact" maxOccurs="unbounded" minOccurs="0"/>
...
public class OrganizationUnit {
    ...
    protected List<OrgUnitContact> contacts;
    @XmlElement(nillable = true)
     ...
     * 
     */
    public List<OrgUnitContact> getContacts() {
        if (contacts == null) {
            contacts = new ArrayList<OrgUnitContact>();
        }
     ...
     *     
     */
    public void setContacts(List<OrgUnitContact> contacts) {
